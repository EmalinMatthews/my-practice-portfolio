...
const Blog = () => {
  ...
  return (
    <section className="bg-secondary text-white px-5 py-32" id="blog">
      <div className="container mx-auto grid md:grid-cols-2 items-center md:justify-between">
        <div className="about-info mb-5">
          <h2 className="text-4xl font-bold mb-5 border-b-[5px] w-[100px] border-black pb-2">
            Blogs
          </h2>
          <p className="pb-5"> (I am going to rewrite the tutorials i used to make
             this site and then turn them into a blog post and link them here)</p>
